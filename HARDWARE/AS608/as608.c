...
{   
  ...
  RCC_APB2PeriphClockCmd(RCC_APB2Periph_GPIOA|RCC_APB2Periph_GPIOB|RCC_APB2Periph_GPIOE, ENABLE);//使能GPIOA时钟
  //初始化读状态引脚GPIOA
  ...
  GPIO_InitStructure.GPIO_Mode = GPIO_Mode_Out_PP;//输入下拉模式
  GPIO_InitStructure.GPIO_Speed = GPIO_Speed_50MHz;//50MHz
